...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
 ...
 // アクションの非同期処理を終えてからVue インスタンスが生成される
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.use(vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]); // パスとコンポーネントのマッピング（定義）
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              // 最初はnull
              context.commit("setApiStatus", null); // API通信が成功した場合も失敗した場合もresponseにレスポンスオブジェクトを代入する
...
var UNPROCESSABLE_ENTITY = 422; //Laravelでは422をレスポンスとする
...
module.exports = __webpack_require__(/*! /Users/rank2/Desktop/dev/Vuesplash/web/resources/js/app.js */"./resources/js/app.js");
